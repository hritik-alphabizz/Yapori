...
class ApiController {
  ...
  Future<ApiResponseModel> getPosts(
    ...
    print("URLLLLLLLLLLLLLLLLLLLLLLLLLLLL " + url);
    url = '$url&page=$page';
    log("workin here! $url and");
    return await http.get(Uri.parse(url), headers: {
      "Authorization": "Bearer ${authKey!}"
    }).then((http.Response response) async {
      final ApiResponseModel parsedResponse =
  ...
  Future<ApiResponseModel> postStory({
    ...
    print(
        "this is my story request ${NetworkConstantsUtil.baseUrl + NetworkConstantsUtil.addStory} and $parameters");
  ...
  Future<ApiResponseModel> postStoryViaPost({
    ...
    var parameters = {"stories": gallery, "share_type": '1'};
    print(
        "this is my story request ${NetworkConstantsUtil.baseUrl + NetworkConstantsUtil.addStory} and $parameters");
  ...
  Future<ApiResponseModel> reactPost(
      bool like, int postId, String emoji) async {
    var url = NetworkConstantsUtil.baseUrl + NetworkConstantsUtil.reactPostUrl;
    // : NetworkConstantsUtil.unlikePost);
    String? authKey = await SharedPrefs().getAuthorizationKey();
  ...
  Future<ApiResponseModel> sharePostCount(int postId) async {
    var url = NetworkConstantsUtil.baseUrl + NetworkConstantsUtil.sharePostUrl;
    // : NetworkConstantsUtil.unlikePost);
    String? authKey = await SharedPrefs().getAuthorizationKey();

    return http.post(Uri.parse(url),
        headers: {"Authorization": "Bearer ${authKey!}"},
        body: {"id": postId.toString()}).then((http.Response response) async {
      log('this i share count =====>>> +++++ $postId');
      final ApiResponseModel parsedResponse =
          await getResponse(response.body, NetworkConstantsUtil.sharePostUrl);
      return parsedResponse;
    });
  }

  Future<ApiResponseModel> viewCounter(int postId) async {
    var url = NetworkConstantsUtil.baseUrl + NetworkConstantsUtil.viewCountUrl;
    // : NetworkConstantsUtil.unlikePost);
    String? authKey = await SharedPrefs().getAuthorizationKey();
    ...
    return http.post(Uri.parse(url), headers: {
      ...
      final ApiResponseModel parsedResponse =
          await getResponse(response.body, NetworkConstantsUtil.viewCountUrl);
      return parsedResponse;
    });
  }
  ...
  Future<ApiResponseModel> deletePost(
      int postId, bool isClubOwner, int clubId) async {
  ...
  Future<ApiResponseModel> changePhone(String countryCode, String phone) async {
    ...
    String? authKey = await SharedPrefs().getAuthorizationKey();
    print(
        'this is update qualification request ${NetworkConstantsUtil.baseUrl + NetworkConstantsUtil.updatePhone}');
    return http.post(Uri.parse(url), headers: {
      "Authorization": "Bearer ${authKey!}"
    }, body: {
  ...
  Future<ApiResponseModel> updateUserLocation(
      String latitude, String longitude, String country) async {
    var url =
  ...
  Future<ApiResponseModel> uploadFile(
    ...
    print(
        'this is upload video requewst --->>>${request.fields.toString()}&& ${request.files.toString()}');
    var res = await request.send();
    var responseData = await res.stream.toBytes();
    var responseString = String.fromCharCodes(responseData);
    final ApiResponseModel parsedResponse =
  ...
  Future<ApiResponseModel> updateBio(String bio) async {
    String? authKey = await SharedPrefs().getAuthorizationKey();
    var url = NetworkConstantsUtil.baseUrl + NetworkConstantsUtil.updateBioData;
    var params = {"bio": bio};
    ...
    return await http
        ...
        .then((http.Response response) async {
      final ApiResponseModel parsedResponse =
          await getResponse(response.body, NetworkConstantsUtil.updateBioData);
      return parsedResponse;
    });
  }
  ...
  Future<ApiResponseModel> updateQualification(String qualification) async {
    String? authKey = await SharedPrefs().getAuthorizationKey();
    var url = NetworkConstantsUtil.baseUrl +
        NetworkConstantsUtil.updateQualificationData;
    var params = {"qualification": qualification};
    print(
        'this is update qualification request ${NetworkConstantsUtil.baseUrl + NetworkConstantsUtil.updateQualificationData} $params');
  ...
  Future<ApiResponseModel> privateModeApi(String private) async {
    ...
    return await http
        ...
        .then((http.Response response) async {
      final ApiResponseModel parsedResponse =
          await getResponse(response.body, NetworkConstantsUtil.privateModeUrl);
      return parsedResponse;
    });
  }
  ...
  Future<ApiResponseModel> createClub(
    ...
    print(
        'this is club create request --->>> ${NetworkConstantsUtil.createClub} $param');
  ...
  Future<ApiResponseModel> getResponse(String res, String url) async {
    try {
      ...
      if (data['status'] == 401 && data['data'] == null) {
        ...
        AppUtil.showToast(message: data['data']['errors'], isSuccess: false);
