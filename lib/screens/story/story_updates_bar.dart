        ...
        builder: (ctx) {
          return ListView.builder(
            ...
            itemBuilder: (BuildContext ctx, int index) {
              print(widget.stories[index].image.toString() + "STORY CLICK");
              if (index == 0) {
                return SizedBox(
                  width: 70,
                              ...
                              child: Column(
                                children: [
                                  widget.stories[index].media.isNotEmpty
                                      ? MediaThumbnailView(
                                          borderColor: widget.stories[index]
                                                      .isViewed ==
                                                  true
                                              ? AppColorConstants.disabledColor
                                              : AppColorConstants.themeColor,
                                          media:
                                              widget.stories[index].media.last,
                                        ).ripple(() {
                                  ...
                                  Expanded(
                                    child: BodySmallText(
                                        LocalizationString.yourStory.tr,
                                        maxLines: 1,
                                        weight: TextWeight.medium),
                                  )
                                ],
                          ...
                          MediaThumbnailView(
                            borderColor:
                                widget.stories[index - widget.liveUsers.length]
                                    ...
                                    : AppColorConstants.themeColor,
                            media: widget
                                .stories[index - widget.liveUsers.length]
                                .media
                                .last,
                          ).ripple(() {
                            widget.viewStoryCallback(widget
                                .stories[index - widget.liveUsers.length]);
                          }).ripple(() {
                            widget.viewStoryCallback(widget
                                .stories[index - widget.liveUsers.length]);
