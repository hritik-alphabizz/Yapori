                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return Padding(
                                        ...
                                        child: UserTile(
                                          ...
                                          videoCallCallback: () {
                                            Get.back();
                                            initiateVideoCall(usersList[index]);
                                          },
                                        ).hP16,
                                      );
                                      // }
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: Text(
                        LocalizationString.sharePostStory,
                        style: TextStyle(color: AppColorConstants.iconColor),
                      )),
                    )
                        .circular
                        .ripple(() async {
                          ...
                          dataMap['image'] =
                              widget.post!.mediaType.toString() == '1'
                                  ? lastPathSegment
                                  : '';
                          dataMap['video'] =
                              widget.post!.mediaType.toString() == '1'
                                  ...
                                  : lastPathSegment;
                          dataMap['type'] =
                              widget.post!.mediaType.toString() == '2'
                                  ? "3"
                                  : widget.post!.mediaType.toString();
                          dataMap['thumbnail'] =
                              // lastPathSegment;
                              widget.post!.type.toString() == '1'
                                  ? lastPathSegment
                                  : thumbnail.toString();
                          dataMap['description'] = '';
                          ...
                          storyController.publishAction(
                              galleryItems: [], postItems: data, isPosts: true);
                          await ApiController()
                  ...
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Center(
                          child: Text(
                        LocalizationString.sharePostOther,
                        style: TextStyle(color: AppColorConstants.iconColor),
                      )),
                    )
                        .circular
                        .ripple(() async {
                          ...
                          dataMap['image'] = widget.post!.type.toString() == '1'
                              ? widget.post!.filePath.toString()
                              : '';
                          dataMap['video'] = widget.post!.type.toString() == '1'
                              ? ''
                              : widget.post!.filePath.toString();
