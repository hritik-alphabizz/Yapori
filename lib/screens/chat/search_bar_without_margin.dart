...
class SearchBarWithoutMargin extends StatefulWidget {
  ...
  @override
  State<SearchBarWithoutMargin> createState() => _SearchBarWithoutMarginState();
}

class _SearchBarWithoutMarginState extends State<SearchBarWithoutMargin> {
