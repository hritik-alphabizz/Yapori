...
class LoginController extends GetxController {
  ...
  updateLocation({required String country, required String city}) {
            ...
            if (response.success) {
              ...
              if (_userProfileManager.user.value!.userName.isEmpty) {
                ...
                await updateLocation(
                    country: countryName.toString(), city: cityName.toString());
  ...
  void register(
    ...
    if (name.contains(' ')) {
      ...
      showErrorMessage('Username should not contain more than 4 numbers');
  ...
  void verifyUsername(String userName) {
    if (_hasMoreThanFourNumbers(userName)) {
      AppUtil.showToast(
          message: 'Username should not contain more than 4 numbers',
          isSuccess: false);
